...
add_action( 'speakers_add_form_fields', 'add_series_image_field', 10, 2 );
...
add_action( 'speakers_edit_form_fields', 'journey_series_edit_meta_field', 10, 2 );
add_action( 'series_edit_form_fields', 'journey_series_edit_meta_field', 10, 2 );
...
function save_series_custom_meta( $term_id ) {
	if ( isset( $_POST['series_image'] ) ) {
		...
		update_option( "speakers_$t_id", $term_meta );
		// Save the option array.
		update_option( "series_$t_id", $term_meta );
	}
}  
add_action( 'edited_speakers', 'save_series_custom_meta', 10, 2 );  
add_action( 'create_speakers', 'save_series_custom_meta', 10, 2 );
add_action( 'edited_series', 'save_series_custom_meta', 10, 2 );  
add_action( 'create_series', 'save_series_custom_meta', 10, 2 );